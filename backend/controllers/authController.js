...
export const registrar = async (req, res) => {
  ...
  try {
    ...
    // ✅ NUEVO: Enviar email de verificación con Nodemailer
...
export const verificarEmail = async (req, res) => {
  ...
  try {
    ...
    // ✅ NUEVO: Enviar email de bienvenida con Nodemailer
...
export const olvideContraseña = async (req, res) => {
  ...
  try {
    ...
    // ✅ NUEVO: Enviar email de restablecimiento con Nodemailer
...
export const restablecerContraseña = async (req, res) => {
  try {
    ...
    // ✅ NUEVO: Enviar confirmación con Nodemailer
